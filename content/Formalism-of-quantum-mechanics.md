...
**Dirac notation** $$ \braket {\psi_1 | \psi_2} = \int dr \psi^* _1 (x) \psi_2 (x)$$
...
**orthogonal** $\braket {\psi_1 | \psi_2} = 0$
**normalized** $\braket {\psi| \psi} = 1$
**orthonormal** (both orthogonal and normalized) $\int dr \psi^* _1 (x) \psi_2 (x) = 0$ 
