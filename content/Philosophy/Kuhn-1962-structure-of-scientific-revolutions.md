...
2. That paradigm was replaced with a new one that light was transverse wave motion
...
**what is included in a paradigm** =
- key formulas and constants that can be applied in many instances
- laws of nature
- puzzles = assumed to have solutions that the paradigm provices resources to solve
- basic theoretical assumptions taken to be true
- the knowledge of the paradigm is recounted in science textbooks or classical books of science (Aristotle's *Physica*, Ptolemy's *Almagest*, Newton's *Principia*, etc. )
	- it "prepares the student for membership in the particular scientific community" (p. 11)
...
**Traditional view of science** described by Kuhn =
...
This traditional concept of science **development-by-accumulation** leads to problems for historians. **Development-by-accumulation** is the traditional view of scientific progress as linear, with new facts continuously being added to the existing body of knowledge. 

Looking at out-of-date beliefs, such as Aristotelian dynamics, gives two pictures:
1. these out-of-date beliefs are myths. This means that "myths can be produced by the same sorts of method and held for the the same sorts of reasons that now lead to scientific knowledge"
