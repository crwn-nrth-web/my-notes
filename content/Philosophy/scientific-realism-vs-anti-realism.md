...
2. other argue that the idea that our theories describe a real world independent of thought and perception is a mistake
...
- saying that scientific realism assumes common sense realism means committing to the everyday picture of the world
- quantum mechanics presents a problem with this = according to quantum mechanics, the state of a physical system is partially determined by measurement which presents problems for the common-sense realist ideas about the relation between human thought and physical reality
	- however, there is more than one interpretation that is compatible with quantum mechanics. Quantum mechanics does not require us to give up common-sense realism

Godfrey-Smith's solution to the problem is to modify common-sense realism to make it more responsive to science,  in order to allow for the possibility of unexpected, uncommon-sensical relations between thoughts and reality. This gives us:
...
Hence, Godfrey-Smith gives the following statement of **scientific realism** =
...
2. One *actual* and *reasonable* aim of science is to give us accurate descriptions (and other representations) of what reality is like. This project includes giving us accurate representations of aspects of reality that are unobservable
	- actual = this is an aim of science to give an accurate description of what reality is like
	- reasonable = we can fail but we will be successful some of the time

**what does it mean by "unobservable"** = 
- Jupiter is observable, electrons is unobservable
> "X is observable to us if there are circumstances which are such that if X is present to us under those circumstances then we observe it (with our unaided senses)" (p.16, Fraassen in *The Scientific Image*)

Godfrey-Smith believes that his statement of scientific realism intends to capture both the optimistic and pessimistic version of scientific realism. But since it claims that it is a reasonable aim of science to give an accurate description of reality, extreme pessimism is not compatible with this view.
### should we be optimistic or pessimistic towards scientific realism?

**optimistic version of scientific realism** = thinks we can be confident that science is succeeding in uncovering the basic structure of the world and how it works
