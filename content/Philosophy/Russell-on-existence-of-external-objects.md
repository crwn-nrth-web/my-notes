---
aliases:
  - Russell-answer-to-Humean-skepticism
tags:
  - philosophy
  - 
draft: false
title: Russell-on-existence-of-external-objects
---
 
> [!source] Bertrand Russell (2014), "The existence of matter" - Chapter 2 of "The Problems of Philosophy"

Russell agrees with [[Skepticism|Humean-skepticism-about-the-external-world]] when it comes to the nature of sensory information. Russell agrees that the sense don't acquaint us directly with external objects and that sensory impressions are fleeting. However, Russell is anti-skeptical on the matter and argues that senses do provide reasonable basis for believing in external objects.

> “Since this belief [in external objects] does not lead to any difficulties, but on the contrary tends to simplify and systematize our account of our experiences, there seems no good reason for rejecting it. We may therefore admit — though with a slight doubt derived from dreams — that the external world does exist, and is not wholly dependent for its existence upon our continuing to perceive it.”

Russell also agrees with [[Cartesian-Skepticism]] that dreams provide a source of doubt concerning the knowledge of the external world because the kind of sense-data we have in waking experiences can be replicated in dreams. 
...
**Hypothesis 2** = only I and my private sense data exist
...
Our sense-data shows continuity over time. Examples given by Russell:
- our sense-data representing the cat in a different parts of the room, with no visual data of the movement in between. The best explanation is that there is a real, physical cat that moved while you weren't looking
...
[^1]: inference to the best explanation is explained by [[Foster-proposed-solution-to-the-problem-of-induction]]. Note that Russell does not use that terminology but it is an implied inference
