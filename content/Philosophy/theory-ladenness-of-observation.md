...
[[Kuhn-1962-structure-of-scientific-revolutions]] is not confidently rejecting [[logical-empiricism|empiricism]] but he does say that the traditional model doesn't function effectively anymore. He still believes sensory experience matters, but what counts as observation statements, what is noticed, how instruments are read, what is relevant, all depend on the [[Kuhn-on-paradigms|paradigm]].

**Example** for the [[scientific-discovery-are-not-discrete-events|paradigm-shift-from-phlogiston-to-oxygen]], saying that "i see oxygen being produced" presupposes the existence of oxygen which is not available to the phlogiston paradigm. Hence this isn't a neutral observation, as it is observation that could only be made by the oxygen paradigm.