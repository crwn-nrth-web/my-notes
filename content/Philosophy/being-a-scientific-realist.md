---
title: being-a-scientific-realist
draft: false
tags:
  - philosophy
aliases:
...
- a reason to be an anti-realist = take the stance similar to hume on the problem of induction. We need to believe that the sun is going to rise tomorrow and in a similar way, scientists need to believe that their theories are attempting to describe the world. But philosophically, scientific realism is a problem. ***what is the point then??***
- compare a scientist who believes that a theory is describing an actual entity and a scientist who accepts the theory but is agnostic whether there is an actual entity = to an outside they would seem exactly the same

Van Fraassen admits acceptance has this commitment component that involves adopting a conceptual framework, speaking with authority on the behalf of the theory, committing to a research program, etc but at what point does this commitment collapse into belief. His account holds that that someone who accepts a theory behaves as someone who believes the theory to be true. Organizing your entire intellectual life around a theory, explaining the world through it, defending it publicly etc means your are *functionally* believing it.
