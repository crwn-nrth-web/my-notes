...
This argument uses **[[Foster-proposed-solution-to-the-problem-of-induction|inference-to-the-best-explanation]]** 
> The best explanation for X is that Y. *Therefore*, it is true that Y

An **objection** to this argument is that scientific theories are designed to be successful in practical ways, so it is not surprising that they are. There are also questions whether [[Foster-proposed-solution-to-the-problem-of-induction|inference-to-the-best-explanation]] is a good form of argument in the first place and brings it back to the [[Hume-on-the-problem-of-induction|problem-of-induction]]. There can be a worry that while an explanation that seems best may not be the *accurate* explanation.