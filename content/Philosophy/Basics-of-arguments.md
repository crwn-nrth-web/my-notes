...
1. A conclusion is *entailed* by premises if it's impossible for all the premises to be true while the conclusion is false. In other words, if all the premises are true, the conclusion must be true
2. an argument is *valid* if the conclusion is entailed by the premises
3. a *deductive argument* is *sound* if the argument is valid and all its premises are true
...
| ------------------------- | ---------------------------------------------------------------------------------------------- |
| **Modus ponens**          | - If *p* then *q* <br>- *p*<br>- hence, *q*                                                    |
| **Modus tollens**         | - if *p* then *q*<br>- *not-q*<br>- hence, *not-p*                                             |
| **Disjunctive syllogism** | - either *p* or *q*<br>- *not-p* / *not-q*<br>- hence *q* / *p*                                |
| **Categorical syllogism** | - All *p*'s are *q*'s<br>- x is (an) *p* / all *q*'s are *r*<br>- x is *q* / all *p*'s are *r* |
