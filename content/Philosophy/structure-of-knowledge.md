...
2. *structure of knowledge is circular* = [[Bonjour-on-coherentism|coherentism]]
	 the initial belief (e.g. A) circles back upon itself as one of the belief's that goes into the justification of A is itself dependent on A.
...
2. a finite mind cannot entertain nor appeal to an infinite series of justifying beliefs
3. if justification actually did require infinite series of justifying beliefs, then we would never be able to accomplish any justification for any belief
Hence, there must be some subset of our beliefs that are epistemically basic in order to stop the infinite regress.
