...
[[logical-empiricism]] implied a criterion based on their [[logical-empiricism#Verification theory of meaning|verification theory of meaning]] = the meaning of a claim lies in its method of verification. This would make verifiable claims scientific and unverifiable ones metaphysical or meaningless
...
Unlike [[confirmation-and-logic#Hypothetico-Deductivisim|hypothetico-deductivism]], which uses both deductive and inductive arguments, Popper's approach rejects the inductive step where predictions confirm hypotheses. He accepts only the deductive argument that uses failed predictions to falsify hypotheses.
...
**_Ad hoc_** moves are designed to save a theory from being proven wrong when faced with contradicting evidence. An **ad hoc hypothesis** is a modification to a theory designed to save it from being proven wrong when faced with contradicting evidence.
...
Choosing falsifiability as the criterion of demarcation solves [[Hume-on-the-problem-of-induction|the problem of induction]].
...
- Hume showed: [[confirmation-and-logic|inductive inferences]] cannot be rationally justified
