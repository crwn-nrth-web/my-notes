...
# Main points of logical empiricism

1. To find a **logical structure of science** = a description of the logical relations between sentences in the theory and the relations between the theory and observation evidence
2. it is based on a *theory of language* and is an attempt to provide epistemological foundations for the formal sciences (mathematical sciences) and the empirical sciences (the natural sciences). 
...
4. logic is the main tool in philosophy
5. The [[#Aim of science according to logical empiricism]] is to track and anticipate patterns in experience

### Analytical/Synthetic statements distinction
**analytical sentences** = analytic sentences are true or false simply in virtue of the meanings of the term within them. These sentences can be known solely by knowing the meaning of the words. For logical empiricists, analytical statements are "empty truths" with no factual content.
- E.G. = "Pediatricians are doctors."

 **synthetic sentences** = synthetic sentences are true or false in virtue of both the meaning of the words and the way the world is. 
 - E.G. = "All pediatricians are rich."

For Logical empiricism, mathematics and logic is analytical as they do not describe the world. Synthetic claims about the world can use mathematical terms ("Jupiter has 79 moons") but proof and investigations within mathematics are analytical. According to logical empiricists, a priori knowledge is analytical and so have no factual content.[^1]
...
The verifiability theory of meaning was replaced by the *holistic empiricist theory of meaning* where theories were seen as abstract structures that connect many hypotheses together. The structures (theories) are connected to the observable realm, but each claim (hypotheses / concepts) do not have some specific set of observations associated with it.
...
1. formulating the verifiability principle of meaning
...
#### Other views than empiricism

 - **Rationalism** = pure reasoning can be a route to knowlegde that does not depend on experience (Descartes, Leibniz) 
 - Kant offered an intermediate position between rationalism and empiricism = there is a subtle interaction between experience and preexisting mental structures that we use to make sense of experience 
