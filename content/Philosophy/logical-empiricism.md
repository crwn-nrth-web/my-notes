...
Logical empiricism was based in theories of languages, with the central idea being the **Verification theory of meaning** = theory that a statement is meaningful only if it is either empirically verifiable through sensory experience or is a tautology. This only applied to a particular kind of meaning -- "factual meaning".
...
- **synthetic sentences**
The terminology analytic/synthetic was introduced by Kant.
...
Importantly, Logical empiricists insisted that pure mathematics is analytical, and divided geometry into two parts =
