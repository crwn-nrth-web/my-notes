...
word $\rightarrow$ meaning = concept
...
Let *a* be any word and *S(a)* be the elementary sentence in which it occurs. Then the sufficient and necessary conditions for *a* being meaningful may be given by each of the following formulations =
...
4. the method of verification of *S(a)* are known

According to Carnap, many words of metaphysics can be shown not to fulfill the above requirement and therefore are devoid of meaning.
#### defining meaningful sentences
For Carnap, meaningful metaphysical statements cannot exist because of the aim of metaphysics = to discover and formulate a kind of knowledge which is not accessible to empirical science

**Types of meaningful statements** =
1. statements which are true by virtue of their form = *tautologies*
